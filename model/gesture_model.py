...
def train_gesture_model(X: torch.Tensor, y: torch.Tensor, gesture_names: List[str],
    ...
    torch.save(model.state_dict(), 'outputs/gesture_model.pth')
    joblib.dump(scaler, 'outputs/gesture_scaler.pkl')
    
    print(f"\nModel saved as 'outputs/gesture_model.pth'")
    print(f"Scaler saved as 'outputs/gesture_scaler.pkl'")
