...
from irds_eda import load_irds_data, load_gesture_labels, filter_dataframe
...
def analyze_repetition_variability(df: pd.DataFrame, subject_id: str, gesture_label: str):
    ...
    plt.tight_layout()
    plt.savefig(f'repetition_analysis_subject_{subject_id}_gesture_{gesture_label}.png', 
...
def compare_subjects_gesture(df: pd.DataFrame, gesture_label: str, max_subjects: int = 3):
    ...
    plt.tight_layout()
    plt.savefig(f'gesture_comparison_{gesture_label}.png', dpi=300, bbox_inches='tight')
    plt.show()
...
if __name__ == "__main__":
    ...
    df = load_irds_data(folder_path="/home/nishant/project/irds/data", max_files=20)
